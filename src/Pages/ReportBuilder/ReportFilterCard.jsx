    ...
    return (
        <div className="p-6 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm space-y-4">
            ...
            <div className="flex gap-3">
                ...
                <button
                    onClick={onSearch}
                    className="px-6 py-1 sm:w-auto md:w-24 text-sm text-white bg-purple-600 hover:bg-purple-700 rounded-md"
                >
                    Search
                </button>
                ...
                <button
                    onClick={handleReset}
                    className="px-7 py-1 sm:w-auto md:w-24 text-sm bg-gray-200 dark:bg-gray-700 rounded-md"
                >
                    Reset
                </button>
