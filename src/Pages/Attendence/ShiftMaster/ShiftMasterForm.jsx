...
const ShiftMasterForm = () => {
    ...
    return (
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm">
            ...
            <h2 className="text-Header font-[500] text-gray-800 dark:text-gray-100 mb-6">
                Shift Master
            </h2>

            <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto_2fr] gap-8">
                ...
                <div className="space-y-5 ">
                    ...
                    <div className="flex gap-4 pt-2">
                        ...
                        <button className="flex items-center gap-2 px-4 py-2 bg-primary text-white rounded-md text-sm">
                            <Save size={14} />
                            Save
                        </button>

                        <button className="flex items-center gap-2 px-4 py-2 bg-gray-200 dark:bg-gray-700 text-sm rounded-md">
                            <RefreshCcw size={14} />
                            Reset
                        </button>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="w-24">
                                    <SelectFieldScroll label="Minute"
                                        name="startMinute"
