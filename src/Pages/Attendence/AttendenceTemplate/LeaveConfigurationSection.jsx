    ...
    "
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <VariableTypeRow
                    ...
                    onCheckedChange={(val) =>
                        handleToggle("displayUnauthorized", val)
                    }
                />
                ...
                <VariableTypeRow
                    ...
                    onCheckedChange={(val) =>
                        handleToggle("displayUnauthorizedAlt", val)
                    }
                />
                ...
                <VariableTypeRow
                    ...
                    onCheckedChange={(val) =>
                        handleToggle("displayLWPPortal", val)
                    }
                />
                ...
                <VariableTypeRow
                    ...
                    onCheckedChange={(val) =>
                        handleToggle("displayLWPForm", val)
                    }
                />
                ...
                <VariableTypeRow
                    ...
                    onCheckedChange={(val) =>
                        handleToggle("employeePunch", val)
                    }
                />
                ...
                <VariableTypeRow
                    ...
                    onCheckedChange={(val) =>
                        handleToggle("displayLateComing", val)
                    }
                />
                ...
                <VariableTypeRow
                    ...
                    onCheckedChange={(val) =>
                        handleToggle("longLeaveFlag", val)
                    }
                />
                ...
                /> */}
                <div className="flex flex-col ">
                    <label className="text-[12px] font-medium text-gray-700 dark:text-gray-200 leading-4 mb-1 min-h-[32px] mt-5">
                ...
                <div className="flex flex-col items">
                    <label className="text-[12px] font-medium text-gray-700 dark:text-gray-200 leading-4 mb-1 h-[52px]">
                        No. of days after which employee can send attendance regularization
                        (OD/Tour/Mispunch etc)
                    </label>
                ...
                <VariableTypeRow
                    ...
                    onCheckedChange={(val) =>
                        handleToggle("noClubWeeklyLWP", val)
                    }
                />
                ...
                <VariableTypeRow
                    ...
                    onCheckedChange={(val) =>
                        handleToggle("noClubHolidayLWP", val)
                    }
                />
                ...
                <VariableTypeRow
                    ...
                    onCheckedChange={(val) =>
                        handleToggle("noLeaveAfterSalary", val)
                    }
                />
                ...
                <VariableTypeRow
                    ...
                    onCheckedChange={(val) =>
                        handleToggle("approveRejectEmail", val)
                    }
                />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <VariableTypeRow
                    ...
                    onCheckedChange={(val) =>
                        handleToggle("yearToDateCredit", val)
                    }
                />
