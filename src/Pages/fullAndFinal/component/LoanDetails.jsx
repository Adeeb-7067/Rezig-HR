...
const LoanDetails = () => {
    ...
    return (
        <div className="space-y-2 mt-4">
            ...
            {/* Table Container */}
            <div className="rounded-sm shadow drop-shadow-xs border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 table-scroll">
                {/* Single scroll container for both header + body */}
                <div className="overflow-x-auto">

                    {/* Inner wrapper sets the minimum width ONCE for header + body */}
                    <div className="min-w-[600px]">

                        {/* Header — no min-w here, inherits from wrapper */}
                        <div
                            className="text-[0.7rem] sm:text-[0.8rem] font-semibold text-white dark:text-gray-50 rounded-t-md dark:border-gray-700 bg-[#8629DF] dark:bg-gray-900 py-1 px-4 min-h-[40px]"
                            style={{
                                display: "grid",
                        ...
                        {/* Body */}
                        <div className="max-h-[260px] overflow-y-auto rounded-b-sm">
                            {data.map((item, index) => (
                                <div
                                    key={index}
