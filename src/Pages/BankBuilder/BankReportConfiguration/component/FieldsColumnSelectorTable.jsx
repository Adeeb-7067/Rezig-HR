...
import { CircleEqual, Equal, X } from "lucide-react";

const FieldsColumnSelectorTable = ({ fields = [], selected = [], removeField }) => {
    ...
    return (
        ...
        <div className="border rounded-lg overflow-hidden">
            ...
            <div className="grid grid-cols-3 bg-primary text-white text-xs font-medium">
