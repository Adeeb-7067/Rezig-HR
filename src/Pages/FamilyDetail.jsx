    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
      <div className="col-span-1">
        ...
        <div className="bg-[#EFEFEF]/70 dark:bg-[#E4E6EB]/10  p-2 grid grid-cols-1 md:grid-cols-2 gap-2 rounded-lg mt-3">
          <InputField label="First Nominee Name" name="firstNominee" />
          <SelectField
        ...
        <div className="bg-[#EFEFEF]/70 dark:bg-[#E4E6EB]/10  gap-2 p-2 rounded-lg mt-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
            <InputField label="Name" name="emergency1Name" />
            <SelectField label="RelationShip" name="emergency1Relation">
              <option>Select Your Relationship</option>
              <option>Child</option>
              <option>Parent</option>
              <option>Sibling</option>
            </SelectField>
            <InputField label="Mobile Number" name="emergency1Mobile" />
            <InputField label="Email ID" name="emergency1Email" />
            <InputField label="Address" name="emergency1Address" />
            <InputField label="TelePhone Number" name="emergency1Telephone" />
          </div>
        </div>
      </div>
      <div className="col-span-1">
        <div className="bg-[#EFEFEF]/70 dark:bg-[#E4E6EB]/10  gap-2 p-2 grid grid-cols-1 md:grid-cols-2 rounded-lg">
          <InputField label="First Child Name" name="firstChildName" />
          <DatePickerField
            label="Date of Birth (First Child)"
            type="Date"
            name="firstChildDob"
          />
          <InputField label="Second Child Name" name="secondChildName" />
          <InputField
          ...
          <InputField label="Religion Name" name="religion" />
        ...
        <div className="bg-[#EFEFEF]/70 dark:bg-[#E4E6EB]/10  p-2 grid grid-cols-1 md:grid-cols-2 gap-2 rounded-lg mt-3">
          <InputField label="Second Nominee Name" name="secondNominee" />
          <SelectField
        ...
        <div className="bg-[#EFEFEF]/70 dark:bg-[#E4E6EB]/10  gap-2 p-2 rounded-lg mt-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
            <InputField label="Name" name="emergency2Name" />
            <SelectField label="RelationShip" name="emergency2Relation">
              <option>Spouse</option>
              <option>Child</option>
              <option>Parent</option>
              <option>Sibling</option>
            </SelectField>
            <InputField label="Mobile Number" name="emergency2Mobile" />
            <InputField label="Email ID" name="emergency2Email" />
            <InputField label="Address" name="emergency2Address" />
            <InputField label="TelePhone Number" name="emergency2Telephone" />
          </div>
        </div>
        <div
          className="
